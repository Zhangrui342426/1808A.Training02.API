...
namespace _1808A.Training02.DAL
{
    public class DBHelper
    {
        ...
        //连接数据库
         static string Sqlconn { get { return _configuration.GetConnectionString("SqlServerConnection"); } set { } }
        ...
        /// <param name="parameter">存储过程需要的参数</param>
        /// <returns></returns>
        public  List<T> GetList<T>(string procName, SqlParameter[] parameter = null)
        {
            try
            {
                //打开
